...
// Non-existent dates: Excel formula D2*10000+C2*100+B2 > 15821004 AND < 15821015
console.assert(validateGregorianDate(1582, 10, 4).valid === true, '1582-10-04 is valid (last Julian day)');
console.assert(validateGregorianDate(1582, 10, 5).valid === false, '1582-10-05 NEEXISTUJE (5 > 4)');
console.assert(validateGregorianDate(1582, 10, 10).valid === false, '1582-10-10 NEEXISTUJE');
console.assert(validateGregorianDate(1582, 10, 14).valid === false, '1582-10-14 NEEXISTUJE (14 < 15)');
console.assert(validateGregorianDate(1582, 10, 15).valid === true, '1582-10-15 valid (first Gregorian day)');
// Verify error message matches Excel "NEEXISTUJE!!!"
console.assert(validateGregorianDate(1582, 10, 10).error === 'NEEXISTUJE!!!', 'gap error is NEEXISTUJE!!!');
console.log('OK');
